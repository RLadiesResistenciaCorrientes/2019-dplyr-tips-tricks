...
Ejemplo: Utilizando el operador pipe
...
Ejemplo: Sin utilizar el operador pipe
...
# Tip 6
### Si quisiéramos conservar sólo la nueva columna en vez de mutate(), usamos transmute()
...
- Podemos reordenar los datos según otro criterio, por ejemplo, en vez de ordenar por países, reordernarlos según año. 
...
#Tip 7: Encontrar los top 5 valores de más altos o más bajos
